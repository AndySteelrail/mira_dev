...
Данный репозиторий содержит готовую сборку для запуска в Docker админ.панели, работающей на "локалхостах". Заказчик - студенческий стартап, дизайн-код специфичен).
